...
`Cloud Logging API`_: Writes log entries and manages your Cloud Logging configuration.
...
.. _samples/: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-logging/samples
